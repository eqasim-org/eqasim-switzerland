...
def calculate_all_enhanced_metrics(original_coords: np.ndarray,
    ...
    results['reidentification'] = calculate_reidentification_risk(
        original_coords, masked_coords
    )
    
    print("  - Calculating location entropy...")
    results['location_entropy_original'] = calculate_location_entropy(original_coords)
    results['location_entropy_masked'] = calculate_location_entropy(masked_coords)
    ...
    results['ripleys_k_original'] = calculate_ripleys_k(original_coords, radii)
    results['ripleys_k_masked'] = calculate_ripleys_k(masked_coords, radii)
    ...
    results['neighbor_preservation'] = calculate_nearest_neighbor_preservation(
        original_coords, masked_coords, k=5
    )
    
    print("  - Calculating displacement direction bias...")
    results['direction_bias'] = calculate_displacement_direction_bias(
        original_coords, masked_coords
    )
    
    print("  - Calculating density correlation...")
    results['density_correlation'] = calculate_density_correlation(
        original_coords, masked_coords
    )
    
    print("  - Calculating query accuracy...")
    results['query_accuracy'] = calculate_query_accuracy(
        original_coords, masked_coords
    )
