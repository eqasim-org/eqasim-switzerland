...
def execute(context):
    ...
    df.loc[(df["position_in_edu"]=="pupil"), "employment_status"]                                     = "pupil"
    df.loc[(df["position_in_edu"]=="apprentice"), "employment_status"]                                = "apprentice"
    ...
    df["synpop_household_id"] = df["person_id"].astype(int)
    ...
    df = df[[
        ...
        "sp_region", "ovgk",
        "synpop_person_id", "synpop_household_id"]]
