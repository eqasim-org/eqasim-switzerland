...
def execute(context):
    ...
    logger.info("Ondeverte imported")
    ...
    logger.info("Passepartout imported")
    ...
    logger.info("Transreno imported")
    ...
    logger.info(f"Number of GTFS networks: {len(gtfs_networks)}")
