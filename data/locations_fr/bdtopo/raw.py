...
def execute(context):    
    source_paths = find_bdtopo("{}/{}".format(context.config("data_path"), "other_locations/FR/bdtopo"))
    ...
    df_bdtopo = df_bdtopo.to_crs("EPSG:2056")
...
def validate(context):
    paths = find_bdtopo("{}/{}".format(context.config("data_path"), "other_locations/FR/bdtopo"))
