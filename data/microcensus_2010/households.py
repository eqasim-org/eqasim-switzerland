...
def execute(context):
    ...
    df_mz_households = pd.read_sas(
        "%s/haushalte.sas7bdat" % data_path, encoding="latin1")

    # Simple attributes
    df_mz_households["home_structure"] = df_mz_households["W_STRUKTUR_AGG"]
    ...
    df_mz_households["number_of_bikes"] = df_mz_households["f32200"]
