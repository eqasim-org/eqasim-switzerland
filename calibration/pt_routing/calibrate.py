...
def configure(context):
    ...
    context.config("calibration_jar_path")
    context.config("calibration_config_path")
...
def execute(context):
    ...
    for _ in range(iterations):
        ...
        jar_path = context.config("calibration_jar_path")
        config_path = context.config("calibration_config_path")
