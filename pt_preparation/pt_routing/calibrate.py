...
import pt_preparation.pt_routing.calibration_utils as calibration_utils
...
def configure(context):
    context.stage("pt_preparation.pt_routing.prepare_input_data")
    context.stage("pt_preparation.pt_routing.generate_config")
    context.stage("pt_preparation.pt_routing.eqasim")
...
def execute(context):
    ...
    reference_data = context.stage("pt_preparation.pt_routing.prepare_input_data")
    ...
    for _ in range(iterations):
        ...
        config_path = context.stage("pt_preparation.pt_routing.generate_config")
