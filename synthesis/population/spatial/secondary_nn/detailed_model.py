...
def configure(context):
    ...
    context.config("detailed_model_learning_rate", 1e-2)
    context.config("detailed_model_torch_num_threads", 16)
    context.config("random_seed")


def execute(context):
    logger.info("Training detailed model (two-input) for level2-within-level1 secondary location choice...")
    ...
    level2_candidate_attributes_by_level1 = build_level2_candidate_attributes_by_level1(children_by_level1, centroid_x_by_l2, centroid_y_by_l2, statent_count_l2, employees_count_l2,
                                                    urban_core_count_l2, urban_count_l2, education_count_l2, shop_count_l2, leisure_count_l2, ovgk_share_a_by_l2, ovgk_share_b_by_l2,
    ...
    _, person_static_scaler_path, person_dynamic_scaler_path = context.stage("synthesis.population.spatial.secondary_nn.coarse_model")
