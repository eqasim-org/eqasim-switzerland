...
def configure(context):
    ...
    context.stage("synthesis.population.trips_kids")


def execute(context):
    df_trips = pd.DataFrame(context.stage("synthesis.population.trips_kids"), copy=True)
    ...
    df_activities.to_csv("activities_all.csv")
