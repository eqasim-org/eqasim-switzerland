...
def walk_travel_time(distance_km, context):
...
def walk_distance(euclidean_distance_km, context):
...
def execute(context):
    ...
    trips["distance_km"] = walk_distance(trips["euclidean_distance_km"], context)
    
    # calculate walking travel time in seconds    
    trips["travel_time_min"] = walk_travel_time(trips["distance_km"], context)
