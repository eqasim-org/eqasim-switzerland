...
def execute(context):
    ...
    df_subprimary.loc[f, "location_x"] = home_location[f, 0] + np.cos(angles) * df_subprimary.loc[
        f, "commute_direct_distance"]
    df_subprimary.loc[f, "location_y"] = home_location[f, 1] + np.sin(angles) * df_subprimary.loc[
        f, "commute_direct_distance"]
    ...
    for purpose in ["work", "education"]:
        ...
        coordinates = np.vstack([df_opportunities.loc[f_opportunities, "location_x"],
                                 df_opportunities.loc[f_opportunities, "location_y"]]).T
        ...
        coordinates = np.vstack(
            [df_subprimary.loc[f_subprimary, "location_x"], df_subprimary.loc[f_subprimary, "location_y"]]).T
