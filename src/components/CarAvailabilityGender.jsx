...
const CarAvailabilityGender = ({ canton, onClose }) => {
  ...
  useEffect(() => {
    ...
    fetch("/data/num_cars_gender.json")
  ...
  return (
    <div className="overlay-panel">
      <h3>{canton || "Zurich"} - Car Availability Class by Gender</h3> 
      ...
      {/* Distribution of Car Availability Class by Gender Plot */}
      <Plot
        data={[
          {
            type: "bar",
        ...
        layout={{
            title: { text: "Car Availability Class by Gender", font: { size: 14 } },
            xaxis: { 
                title: { text: "Car Availability Class", font: { size: 12 } }, 
                tickangle: -45, 
                tickfont: { size: 10 } 
            },
            yaxis: { 
...
export default CarAvailabilityGender