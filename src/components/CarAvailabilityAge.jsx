...
const CarAvailabilityAge = ({ canton, onClose }) => {
  ...
  return (
    <div className="overlay-panel">
      <h3>{canton || "Zurich"} - Car Availability Class by Age</h3> 
      ...
      {/* Distribution of Car Availability by Age Plot */}
      <Plot
        data={[
          {
            type: "bar",
        ...
        layout={{
            title: { text: "Car Availability Class by Age", font: { size: 14 } },
            xaxis: { 
...
export default CarAvailabilityAge