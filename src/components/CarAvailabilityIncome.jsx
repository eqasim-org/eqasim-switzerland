...
const CarAvailabilityIncome = ({ canton, onClose }) => {
  ...
  useEffect(() => {
    ...
    fetch("/data/num_cars_income.json")
  ...
  return (
    <div className="overlay-panel">
      <h3>{canton || "Zurich"} - Car Availability Class by Income</h3> 
      ...
      {/* Distribution of Car Availability by Income Plot */}
      <Plot
        data={[
          {
            type: "bar",
        ...
        layout={{
            title: { text: "Car Availability Class by Income", font: { size: 14 } },
            xaxis: { 
...
export default CarAvailabilityIncome