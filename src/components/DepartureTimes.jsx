...
const DepatureTimes = ({ canton, onClose }) => {
  ...
  useEffect(() => {
    ...
    fetch("/data/departure_times.json")
  ...
  return (
    <div className="overlay-panel">
      <h3>{canton || "Zurich"} - Depature Times by Activity</h3> 
        ...
        data={[
          {
            ...
            text: durations.map((hour) => (data["Microcensus"][selectedVariable][hour]).toFixed(2)),
            textposition: "auto",
          },
          {
            type: "bar",
            ...
            text: durations.map((hour) => (data["Synthetic"][selectedVariable][hour]).toFixed(2)),
            textposition: "auto",
          },
        ]}
        layout={{
            title: { text: "Depature Times for Activities", font: { size: 14 } },
            xaxis: { 
                title: { text: "Departure Time [HH:mm:ss]", font: { size: 12 } }, 
                tickangle: -45, 
                tickfont: { size: 10 } 
            },
            yaxis: { 
