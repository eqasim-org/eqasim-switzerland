...
def execute(context):       
    if context.config("only_weekday"):
        return None # this data doesn't have weekdays only option
    
    # paths and parameters  
    saint_gallen_counts_data  = context.stage("analysis.counts.cantons.saint_gallen")
    city = "saint_gallen"
    ...
    # load counts
    counts = Counts(file_path=saint_gallen_counts_data, id_column="objectid",
