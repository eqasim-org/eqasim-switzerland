...
def execute(context):
    ...
    linkstats_gz_path = os.path.join(simulation_output, "ITERS", f"it.{last_iteration}", f"{last_iteration}.linkstats.txt.gz")
    linkstats_path = os.path.join(output_dir, f"{last_iteration}.linkstats.txt")
