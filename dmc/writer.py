...
NAMES_CONVERSION = {
    ...
    'beta_bike_work': 'bike.betaDestinationWork_u',
    'beta_bike_destination': 'bike.betaUrbanDestination_u',
    ...
    'beta_car_destination': 'car.betaUrbanDestination_u',
    'beta_car_work': 'car.betaDestinationWork_u',
    ...
    'beta_car_passenger_destination': 'cp.betaUrbanDestination_u',
    'beta_car_passenger_work': 'cp.betaDestinationWork_u',
    'beta_car_passenger_driving_permit': 'cp.betaDrivingLicense_u',
    'beta_car_passenger_short_distance': 'cp.betaShortDistance_u',
    'beta_car_passenger_distance_km': 'cp.betaDistance_km',
    'lambda_car_passenger_distance': 'cp.distanceExponent',
